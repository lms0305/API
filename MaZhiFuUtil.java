...
/**
 * 码支付
 * Created by GeneratorCode on 2019/04/25
 */
public class MaZhiFuUtil{
     ...
     * @throws IOException
     */
    public void creatOrders( HttpServletRequest request, HttpServletResponse response) throws IOException {
        String token = "***************"; //记得更改 http://codepay.fateqq.com 后台可设置
        String codepay_id ="***" ;//记得更改 http://codepay.fateqq.com 后台可获得
        Date date=new Date();
